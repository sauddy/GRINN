...
CONTINUITY_IC_WEIGHT = 0.1 # Weight for enforcing continuity at t=0: rho_t(0) = -rho0 * div v0
DECAY_PORTION = 0.2 # Fraction of total training steps over which to fully decay
